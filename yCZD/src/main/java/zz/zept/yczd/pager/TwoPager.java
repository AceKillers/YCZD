...
import zz.zept.yczd.activity.DailyActiviyt.PopupWindows;
...
public class TwoPager extends BasePager implements OnClickListener {
	...
	public View initView() {
		...
		view = View.inflate(context, R.layout.activity_daily2, null);
		btn_no = (Button) view.findViewById(R.id.btn_no);
		btn_back = (Button) view.findViewById(R.id.btn_back);
		btn_back.setVisibility(View.GONE);
		bt_query = (Button) view.findViewById(R.id.bt_query);
		et__time = (EditText) view.findViewById(R.id.et__time);
		lv_daily = (ListView) view.findViewById(R.id.lv_daily);
		...
		case R.id.btn_more:
			...
			DownloadListener downloadListener = new DownloadListener() {
				...
				public void onProgress(int arg0, int arg1, long arg2) {
					// TODO Auto-generated method stub
					ToastUtils.showToast(context, "已下载:" + arg1 + "%");
				}
				...
				public void onFinish(int arg0, String arg1) {
					...
					FileUtil.openFile(context, new File(AppConfig.getInstance().APP_PATH_ROOT + "/日报.xls"));
				}
	...
	private void getServiceData() {
		...
		HttpListener<String> callback = new HttpListener<String>() {
			...
			public void onSucceed(int what, Response<String> response) {
				// TODO Auto-generated method stub
				ToastUtils.showToast(context, "长按展示可下载表格");
				...
				BaseAdapter adapter = new BaseAdapter() {
					...
					public View getView(int position, View convertView, ViewGroup parent) {
						...
						if (convertView == null) {
							view = View.inflate(context, R.layout.item_daily, null);
						} else {
							view = convertView;
						}
