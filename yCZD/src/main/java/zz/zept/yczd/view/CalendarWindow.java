...
public class CalendarWindow extends PopupWindow {
    String date = null;
    public CalendarWindow(Context mContext, final TextView parent) {
        ...
        // 监听所选中的日期
        calendar.setOnCalendarClickListener(new MyCalendarView.OnCalendarClickListener() {
        ...
        // 监听当前月份
        calendar.setOnCalendarDateChangedListener(new MyCalendarView.OnCalendarDateChangedListener() {
